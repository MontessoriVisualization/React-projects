...
import PieceContext from "./piceContext";
...
const PiceContextProvider = ({ children }) => {
  const board = {
  ...
  const [initPiece, setInitPiece] = React.useState(board);

  return (
    <PieceContext.Provider value={{ initPiece, setInitPiece }}>
      {children}
    </PieceContext.Provider>
  );
};

export default PiceContextProvider;
